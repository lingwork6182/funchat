# -*- coding:utf-8 -*-
"""
@NAME: KnowledgeFileModel.py
@Auth: dabin
@Date: 2025/4/25
"""
from src.app.models.Base import Base
from sqlalchemy import Column, Integer, String, DateTime, Float, Boolean, func, JSON


class KnowledgeFileModel(Base):
    __tablename__ = 'knowledge_file'
    __table_args__ = {'comment': '知识文件模型'}
    ...
    text_spliter_name = Column(String(50), comment='文本分割器名称')
...
class FileDocModel(Base):
    ...
    __table_args__ = {'comment': '文件-向量库文档模型'}
